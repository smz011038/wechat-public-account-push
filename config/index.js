...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxaeccb94aaf4bec62',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '171d408f3c1e4146cfacb9f772ac31ea',
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'FBEVSouXGtOPLZnX9EBmIJRw4wytFZmsvLiUHNJGOuQ',
      // 所在省份
      province: '江西',
      // 所在城市
      city: '南昌',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '吴玉婷农历', year: '2003', date: '04-14',
        },
        {
        ...
        {
          type: '生日', name: '吴玉婷', year: '2003', date: '04-14',
        },
        {
